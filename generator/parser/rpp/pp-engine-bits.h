...
template <typename InputIterator>
InputIterator pp::eval_expression (InputIterator __first, InputIterator __last, Value *result)
{
  return __first = eval_constant_expression (skip_blanks (__first, __last), __last, result);
}

template <typename InputIterator>
InputIterator pp::handle_if (InputIterator __first, InputIterator __last)
{
  if (test_if_level())
    {
...
template <typename InputIterator>
InputIterator pp::handle_elif (InputIterator __first, InputIterator __last)
{
  assert(iflevel > 0);
...
template <typename InputIterator>
InputIterator pp::handle_endif (InputIterator __first, InputIterator /*__last*/)
{
  if (iflevel == 0 && !skipping())
    {
...
template <typename InputIterator>
InputIterator pp::handle_ifdef (bool check_undefined, InputIterator __first, InputIterator __last)
{
  if (test_if_level())
    {
      InputIterator end_macro_name = skip_identifier (__first, __last);
...
template <typename InputIterator>
InputIterator pp::handle_undef(InputIterator __first, InputIterator __last)
{
...
template <typename InputIterator>
char pp::peek_char (InputIterator __first, InputIterator __last)
{
  if (__first == __last)
    return 0;
...
template <typename InputIterator>
InputIterator pp::next_token (InputIterator __first, InputIterator __last, int *kind)
{
  __first = skip_blanks (__first, __last);
  ...
  switch (ch)
    {
      ...
      default:
        if (pp_isalpha (ch) || ch == '_')
          {
            InputIterator end = skip_identifier (__first, __last);
          ...
          {
            InputIterator end = skip_number (__first, __last);
